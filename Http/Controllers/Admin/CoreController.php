...
class CoreController extends Controller
{
    ...
    public function index()
    {
        ...
        $can_access_to_schedule = \App\Repository\Admin\MenuRepository::exist ('admin::' . module_route_prefix ('.') . 'core.schedule.list');
        // $can_access_to_schedule_index = \App\Repository\Admin\MenuRepository::exist ('admin::' . module_route_prefix ('.') . 'core.schedule.index');
        $can_access_to_data_route = \App\Repository\Admin\MenuRepository::exist ('admin::' . module_route_prefix ('.') . 'core.dataRoute.list');
        // $can_access_to_data_route_index = \App\Repository\Admin\MenuRepository::exist ('admin::' . module_route_prefix ('.') . 'core.dataRoute.index');
