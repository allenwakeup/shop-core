...
@section('content')
    ...
    <div class="layui-card">
        <div class="layui-form layui-card-header light-search">
            ...
            @include('admin.searchField', ['data' => Goodcatch\Modules\Core\Model\Admin\Attachment::$searchField])
        ...
        <div class="layui-card-body">
            <table class="layui-table" lay-data="{url:'{{ route('admin::' . module_route_prefix ('.') . 'core.attachment.list') }}?{{ request()->getQueryString() }}', page:true, limit:50, id:'test', toolbar:'<div><a href=\'{{ route('admin::' . module_route_prefix ('.') . 'core.attachment.create') }}\'><i class=\'layui-icon layui-icon-add-1\'></i>新增附件</a></div>'}" lay-filter="test">
                <thead>
                <tr>
                    <th lay-data="{field:'id', width:80, sort: true}">ID</th>
                    @include('admin.listHead', ['data' => Goodcatch\Modules\Core\Model\Admin\Attachment::$listField])
